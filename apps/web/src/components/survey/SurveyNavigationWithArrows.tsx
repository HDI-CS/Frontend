        ...
        <div className="flex w-full items-center justify-between gap-2 sm:contents sm:w-auto">
          ...
          >
            ...
            <button
              ...
              className={clsx(
                'sm:w-55 xl:w-70 w-full whitespace-nowrap rounded-xl px-4 py-3 text-sm font-medium shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 sm:px-4 lg:w-60 lg:px-5 xl:px-6',
                {
                  // 로딩 중
                  'cursor-not-allowed bg-[#314158] text-white':
                    isLoading || isTempSaving,
                  // 전체 완료 → 파란색 제출 버튼
                  'bg-[#314158] text-white hover:bg-[#243041]':
